            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3">
                  <Link href="/admin/product-form" className="flex items-center justify-center rounded-md border   border-transparent bg-green-700 mt-3 mx-8 px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-500 w-36">
                    Add New Product
                  </Link>
