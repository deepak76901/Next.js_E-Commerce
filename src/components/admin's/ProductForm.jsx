...
import { fetchProductById } from "@/Redux/apis/ProductAPI";
...
export default function ProductForm() {
  ...
  useEffect(() => {
    if (createdProduct) {
      redirect(`/product-detail/${createdProduct._id}`);
    }
      ...
      >
        <div className="space-y-12">
                ...
                <div className="mt-2">
                  <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset sm:max-w-md">
                    <input
                      ...
                      id="title"
                      className="block flex-1 border-0 bg-transparent py-1.5  text-gray-900 placeholder:text-gray-400  sm:text-sm sm:leading-6 px-3"
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="sm:col-span-6">
            ...
            <div className="mt-2">
              <div className="flex rounded-md grid-cols-2 shadow-sm ring-1 ring-inset focus-within:ring-2 focus-within:ring-inset sm:max-w-md">
                <input
                  type="number"
                  {...register("price", {
